...
export const GET_SINGLE_CONVERSATION_SUCCESS =
  "GET_SINGLE_CONVERSATION_SUCCESS";
export const GET_SINGLE_CONVERSATION_FAIL = "GET_SINGLE_CONVERSATION_FAIL";

export const GET_NEWEST_CONVERSATION_SUCCESS =
  "GET_NEWEST_CONVERSATION_SUCCESS";
