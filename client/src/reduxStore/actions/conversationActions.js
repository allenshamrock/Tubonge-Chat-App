...
export const getSelectedConversationAction = (friendId) => async (dispatch) => {
  try {
...
export const editMessageAction = (message, messageId) => async (dispatch) => {
  try {
...
export const seenMessageAction = (conversationId) => async (dispatch) => {
  try {
...
export const clearConversationAction = (conversationId) => async (dispatch) => {
  try {
...
export const getNewestConversationAction =
