...
export const getNewFriendsAction = () => async (dispatch) => {
  try {
...
export const getAllFriendRequestsAction = () => async (dispatch) => {
  try {
...
export const sendFriendRequestAction = (friendId) => async (dispatch) => {
  try {
...
export const rejectFriendRequestAction = (friendId) => async (dispatch) => {
  try {
...
export const acceptFriendRequestAction = (friendId) => async (dispatch) => {
  try {
...
export const blockFriendAction = (friendId) => async (dispatch) => {
  try {
...
export const unblockFriendAction = (friendId) => async (dispatch) => {
  try {
...
export const searchFriendsAction = (value) => async (dispatch) => {
  try {
